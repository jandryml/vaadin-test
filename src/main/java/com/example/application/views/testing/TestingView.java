package com.example.application.views.testing;
...
@PermitAll
public class TestingView extends Div {

    public TestingView() {
        addClassNames("testing-view", "flex", "flex-col", "h-full", "items-center", "justify-center", "p-l",
